...
?>
					...
					<div class="modal fade" id="panel-config" tabindex="-1" role="dialog" aria-hidden="true">
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<form method="post" action="customers.php"  enctype="multipart/form-data" role="form" class="smart-wizard form-horizontal" id="form" >
								<div class="modal-body">
									<div class="form-group">
														...
														<div class="col-sm-7">
															<input type="text" class="form-control" id="name" required name="name" placeholder="First and Last Name">
														</div>
													</div>
														...
														<div class="col-sm-7">
															<input type="phone" class="form-control" id="name" required name="phone" placeholder="Enter Phone Number">
														</div>
													</div>
													...
													<div class="form-group">
														...
														<div class="col-sm-7">
															<input type="email" class="form-control" id="name" required name="email" placeholder="Enter Email">
														</div>
													</div>
											...
											<input type="radio" value="Male" name="sex" class="green">
											Male
										</label>
										<label class="radio-inline">
											<input type="radio" value="Female" name="sex" class="purple">
											Female
										</label>
														</div>
													</div>
													...
													<div class="form-group">
														...
														<div class="col-sm-7">
															<textarea type="text" class="form-control" id="name" required name="location" placeholder="Enter Location"></textarea>
														</div>
													</div>
										...
										<thead>
												...
												while ($row = mysqli_fetch_array($query)) {
													echo '<tr>
														...
														<a class=""#panel-config" data-toggle="modal" href="#" data-toggle="modal">
			...
			<a href="inc/serv_delete.php?id='.$row['id'].'" onclick="return confirm(\'Are you sure you want to DELETE this Service ?\');" class="btn btn-danger">
