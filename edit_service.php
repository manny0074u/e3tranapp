...
if (isset($_POST['submit'])) {
 ...
 $sql = "UPDATE services SET name='".$name."' , price='".$price."' WHERE id=".$rowid;
						...
						<div class="row">
							<div class="col-md-12">
								...
								$rw = mysqli_fetch_array($query);
											...
											echo '<form method="post" action="edit_service.php?action=update&id='.$rowid.'" enctype="multipart/form-data" role="form" id="form">
												<div class="row">
													<div class="col-md-12">
