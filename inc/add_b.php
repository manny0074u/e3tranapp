            ...
            if(!$_FILES['picture']['error'])
            {
                ...
                if($valid_file)
                {
                 ...
                 echo "<script>alert('Fields are empty !'); </script>";
                        ...
                        move_uploaded_file($_FILES['picture']['tmp_name'], 'images/blog/'.$fileName);
                    ...
                    $sql = "INSERT INTO blog VALUES('','".$name."','".$details."','".$fileName."','1','1','".$upload_date."')";
                     $query = mysqli_query($con, $sql);

                     echo "<script>alert('Blog successfully added!'); window.location='blog.php' </script>";
