...
//if (isset($_POST['name']) and isset($_POST['details'])){
            ...
            if(!$_FILES['picture']['error'])
            {
                ...
                if($valid_file)
                {
                 ...
                 echo "<script>alert('Fields are empty !'); </script>";
                        ...
                        move_uploaded_file($_FILES['picture']['tmp_name'], 'images/product/'.$fileName);
                    ...
                    $sql = "INSERT INTO product VALUES('','".$name."','".$fileName."','".$price."','1','1','".$upload_date."')";
