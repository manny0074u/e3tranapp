            ...
            if(!$_FILES['picture']['error'])
            {
                ...
                if($valid_file)
                {
                 ...
                 echo "<script>alert('Fields are empty !'); </script>";
                        ...
                        move_uploaded_file($_FILES['picture']['tmp_name'], 'images/service/'.$fileName);
                    ...
                    $sql = "INSERT INTO services VALUES('','".$name."','".$details."','".$fileName."','1','1','".$upload_date."')";
                     $query = mysqli_query($con, $sql);

                     echo "<script>alert('Service successfully added!'); window.location='service.php' </script>";
