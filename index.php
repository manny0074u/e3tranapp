...
<!-- Mirrored from www.cliptheme.com/demo/rapido/login_login.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 25 Apr 2016 13:53:20 GMT -->
<head>
		...
		<div class="row">
			<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
				...
				<div class="box-forgot">
					...
					<form class="form-forgot" action="index.php" method="post">
						<div class="errorHandler alert alert-danger no-display">
							<i class="fa fa-remove-sign"></i> You have some form errors. Please check below.
						</div>
						<fieldset>
...
<!-- Mirrored from www.cliptheme.com/demo/rapido/login_login.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 25 Apr 2016 13:53:22 GMT -->
</html>