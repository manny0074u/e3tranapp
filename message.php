...
if($rw['notify'] == 1){
	$sql = "UPDATE message SET notify = 0 WHERE id='".$_GET['id']."'";
	$query = mysqli_query($con, $sql);
									...
									<div class="panel-body messages">
										...
										<ul class="messages-list col-md-4">
											...
											<li class="messages-item">
												...
												<img alt="" src="assets/images/anonymous.jpg" class="messages-item-avatar">
												<span class="messages-item-from"><?php echo $row['name'] ?></span>
												<div class="messages-item-time">
													<span class="text"><?php echo $row['time'] ?></span>
												...
												<span class="messages-item-subject"><?php echo $row['subject'] ?> ...</span>
												<span class="messages-item-preview"> <?php echo substr($row['message'], 0, 60); ?>...</span>
											</li>
										...
										<div class="messages-content col-md-8">
											<div class="message-header">
												...
												<?php
													echo '<a title="Reply" href="reply.php?id='.$row['id'].'"><i class="fa fa-reply"></i></a>

													<a title="Reply" <a href="inc/delete_message.php?id='.$row['id'].'" onclick="return confirm(\'Are you sure you want to DELETE this MESSAGE ?\');"><i class="fa fa-trash-o"></i></a>
													';
...
<!-- Mirrored from www.cliptheme.com/demo/rapido/pages_messages.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 25 Apr 2016 13:53:18 GMT -->
</html>