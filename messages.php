					...
					<div class="modal fade" id="panel-config" tabindex="-1" role="dialog" aria-hidden="true">
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<input type="text"  hidden value="NO NAME" required name="name" >
										...
										<div class="row">
											<div class="col-md-12 space20">
												...
												<button class="btn btn-green">
													Sent Emails <i class="fa fa-envelope-o"></i>
												</button>
												</a>
										...
										<thead>
												...
												while ($row = mysqli_fetch_array($query)) {
													echo '<tr>
														...
														<td>
			<a href="message.php?id='.$row['id'].'"  class="btn btn-blue">
										               <i class="glyphicon glyphicon-search icon-white"></i>
														</a></td>


														<td>
			<a href="inc/delete_message.php?id='.$row['id'].'" onclick="return confirm(\'Are you sure you want to DELETE this Message ?\');" class="btn btn-danger">
