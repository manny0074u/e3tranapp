...
$rwid = $_GET['id'];
								...
								$sql = "SELECT * FROM sent_message WHERE id='".$_GET['id']."'";
										...
										<div class="messages-content col-md-8">
											<div class="message-header">
												...
												<?php
													...
													<a title="Reply" <a href="inc/delete_sentmsg.php?id='.$row['id'].'" onclick="return confirm(\'Are you sure you want to DELETE this MESSAGE ?\');"><i class="fa fa-trash-o"></i></a>
													';
