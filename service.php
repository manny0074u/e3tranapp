				...
				<div class="main-content">
					...
					<div class="modal fade" id="panel-config" tabindex="-1" role="dialog" aria-hidden="true">
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<form method="post" action="service.php"  enctype="multipart/form-data" role="form"  id="form" >
					...
					<div class="container">
								...
								echo '
										...
										<thead>
												...
												while ($row = mysqli_fetch_array($query)) {
													echo '<tr>
													<td><img src="images/service/'.$row['picture'].'" alt="" width="100" height="100"></td>
						...
						<td>
														...
														<a class="panel-config1" href="edit_service.php?id='.$row['id'].'" data-toggle="modal">
