			...
			<div class="main-container inner">
				...
				<div class="main-content">
					...
					<div class="modal fade" id="panel-config" tabindex="-1" role="dialog" aria-hidden="true">
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<form method="post" action="services.php"  enctype="multipart/form-data" role="form" class="smart-wizard form-horizontal" id="form" >
								<div class="modal-body">
									<div class="form-group">
														<label class="col-sm-3 control-label">
															Service Nmae  <span class="symbol required"></span>
														</label>
														<div class="col-sm-7">
									...
									<div class="form-group">
														<label class="col-sm-3 control-label">
															Service Price <span class="symbol required"></span>
														</label>
														<div class="col-sm-7">
					...
					<div class="container">
										...
										<thead>
												...
												while ($row = mysqli_fetch_array($query)) {
													echo '<tr>
														...
														if ($row['status'] == 0){
														echo '<td>
														<a href="inc/vic_status.php?id='.$row['id'].'">
						...
						echo '<td>
						<a href="inc/serv_status.php?id='.$row['id'].'">
														...
														<td><a class=""#panel-config" data-toggle="modal" href="edit_service.php?id='.$row['id'].'" data-toggle="modal">
