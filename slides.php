...
?>
				...
				<div class="main-content">
					...
					<div class="modal fade" id="panel-config" tabindex="-1" role="dialog" aria-hidden="true">
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<form method="post" action="slides.php"  enctype="multipart/form-data" role="form" class="smart-wizard form-horizontal" id="form" >
								<div class="modal-body">
									<div class="form-group">
														...
														<div class="col-sm-7">
															<input type="text" class="form-control" id="name" required name="title" placeholder="Enter Picture  Title">
														</div>
													</div>
									...
									<div class="fileupload fileupload-new" data-provides="fileupload">
														...
														<div>
															<span class="btn btn-light-grey btn-file"><span class="fileupload-new"><i class="fa fa-picture-o"></i> Select  picture</span><span class="fileupload-exists"><i class="fa fa-picture-o"></i> Change</span>
					...
					<div class="container">
										...
										<thead>
												...
												while ($row = mysqli_fetch_array($query)) {
													...
													<td><img src="images/'.$row['picture'].'" alt="" width="100" height="100"></td>
														...
														if ($row['status'] == 0){
														echo '<td>
														<a href="inc/slide_status.php?id='.$row['id'].'">
						...
						<a href="inc/slide_status.php?id='.$row['id'].'">
														...
														<td>
			<a href="inc/slide_delete.php?id='.$row['id'].'" onclick="return confirm(\'Are you sure you want to DELETE this PICTURE ?\');" class="btn btn-danger">
			...
			<footer class="inner">
				<div class="footer-inner">
					<div class="pull-left">
						2017 &copy; Admin portal by <a href="http://e3tech.com.ng" target="blank_"> E3 Technologies</a>
					</div>
...
<!-- Mirrored from www.cliptheme.com/demo/rapido/table_export.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 25 Apr 2016 13:54:43 GMT -->
</html>