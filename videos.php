				...
				<div class="main-content">
					...
					<div class="modal fade" id="panel-config" tabindex="-1" role="dialog" aria-hidden="true">
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<form method="post" action="videos.php"  enctype="multipart/form-data" role="form" class="smart-wizard form-horizontal" id="form" >
								<div class="modal-body">
									<div class="form-group">
														<label class="col-sm-3 control-label">
															Video Title  <span class="symbol required"></span>
														</label>
														<div class="col-sm-7">
									...
									<div class="form-group">
														<label class="col-sm-3 control-label">
															Video Link  <span class="symbol required"></span>
														</label>
														<div class="col-sm-7">
															<textarea type="text" class="form-control" id="name" required name="link" placeholder="Enter YouTube video link"></textarea>
														</div>
													</div>
					...
					<div class="container">
						...
						<a href="inc/vic_status.php?id='.$row['id'].'">
														...
														<td><a class=""#panel-config" data-toggle="modal" href="edit_vic.php?id='.$row['id'].'" data-toggle="modal">
														...
														<td>
			<a href="inc/vic_delete.php?id='.$row['id'].'" onclick="return confirm(\'Are you sure you want to DELETE this VIDEO ?\');" class="btn btn-danger">
